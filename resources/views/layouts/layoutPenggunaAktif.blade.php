        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="content-block">
                    <img src="/img/logo.png" style="width:30%;height:20%;" alt="">
                    <div class="box">
                        <form id="searchbox" style="background-color:transparent;" method="get" action="/search"
                              autocomplete="off">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6" id="comment_form">
                    ...
                    <div class="footer-pad">
                        <div>
                            <input type="komentar" name="komentar" value="Komentar"
                                   style="text-align:center;color:black;">
                        </div>
                        <br>
                        <ul class="list-unstyled">
                            <li><img src="img/lokasi.png" alt="#" style="width: 10%;height: 10%;"></li>
                            <li>Lokasi umum kost :</li>
                            <br>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="social-network social-circle">
                        ...
                        <br>
                        <li>
                            <a href="#" class="icoWhatshapp" title="Whatsapp"><i class="fa fa-whatsapp"></i></a>0822 -
                            xxxx - xxxx
                        </li>
                    </ul>
                </div>
