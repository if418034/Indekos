                    ...
                    <form id="validationform" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" required="" name="nama" id="nama" data-parsley-maxlength="6"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" required="" name="harga" id="harga" data-parsley-maxlength="6"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" required="" name="alamat" id="alamat" placeholder=""
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
