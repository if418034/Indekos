            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="validationform" method="post" enctype="multipart/form-data"
                          action="{{url('/postTambahPemilikKost')}}">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Nama Pemilik</label>
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" required="" name="nama" id="nama" placeholder=""
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" required="" name="alamat" id="alamat" data-parsley-maxlength="6"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" required="" name="telepon" id="telepon" placeholder=""
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
